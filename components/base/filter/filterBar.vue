<template>
    <div class="filterbar" :style="{'top': top + 'px'}">
        <div class="container" :class="{'top-line':topLine,'bottom-line':bottomLine}">
            ...
            <filter-bar-pop :filterTop="top" :show-dialog="isShow" :hasTabHeader="hasTabHeader" :menu="selectedMenu" @changeTab="handleChangeTab" @changeMainItem="handleChangeMainItem" @changeSelect="changeSelect" @closeDialog="handleCloseDialog"></filter-bar-pop>
        </div>
    </div>
</template>
<script>
