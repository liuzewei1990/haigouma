...
import * as XScroll from './vux-xscroll/build/cmd/xscroll.js'
console.log(XScroll)
// import * as Pulldown from './vux-xscroll/build/cmd/plugins/pulldown'
// import * as Pullup from './vux-xscroll/build/cmd/plugins/pullup'
// let XScroll = require("./vux-xscroll/build/cmd/xscroll.js");
// let Pulldown = require("./vux-xscroll/build/cmd/plugins/pulldown");
// let Pullup = require("./vux-xscroll/build/cmd/plugins/pullup");
